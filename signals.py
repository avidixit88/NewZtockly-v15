...
def compute_scalp_signal(
    ...
    *,
    ...
    # Some downstream logic (entry model / proximity helpers / TP logic) may reference
    # `ref_vwap` even if later blocks short-circuit (e.g., when returning early or when
    # certain indicators are unavailable). This prevents UnboundLocalError.
    try:
        _rv = vwap_use.iloc[-1]
